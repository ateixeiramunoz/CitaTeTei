 ...
 *     instancia del servicio genérico {@link GenericServiceConJPA} necesario para acceder a los datos de la entidad. Esto permite la
 *     separación de responsabilidades y facilita la prueba y la flexibilidad de intercambio de implementaciones.</li>
 *     <li>Inyección de dependencias (DI): El controlador se inyecta con una instancia del servicio genérico {@link GenericServiceConJPA}
...
public abstract class MiControladorGenerico<T> {
     ...
     */
    @GetMapping("/{id}")
    public String getById(@PathVariable Object id, @PathVariable String entityName, Model model) {
            this.entityPrefix = entityName + "/";
     ...
     */
    @PostMapping
    public String create(@ModelAttribute("entity") T entity, Model model, @PathVariable String entityName) {
        this.entityPrefix = entityName + "/";
     ...
     */
    @PutMapping("")
    public String update(@PathVariable Object id, @ModelAttribute  T entity, Model model,@PathVariable String entityName) {
        this.entityPrefix = entityName + "/";
     ...
     */
    @DeleteMapping("/{id}")
    public String delete(@PathVariable Object id,@PathVariable String entityName) {
        this.entityPrefix = entityName + "/";
        service.delete(id);
